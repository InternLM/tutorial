...
- [XTuner大模型单卡低成本微调实战](#xtuner大模型单卡低成本微调实战)
  - [1 概述](#1-概述)
    - [1.1 XTuner](#11-xtuner)
    - [1.2 支持的开源LLM (2023.11.01)](#12-支持的开源llm-20231101)
    - [1.3 特色](#13-特色)
    - [1.4 微调原理](#14-微调原理)
  - [2 快速上手](#2-快速上手)
    - [2.1 平台](#21-平台)
    - [2.2 安装](#22-安装)
    - [2.3 微调](#23-微调)
      - [2.3.1 准备配置文件](#231-准备配置文件)
      - [2.3.2 模型下载](#232-模型下载)
      - [2.3.3 数据集下载](#233-数据集下载)
      - [2.3.4 修改配置文件](#234-修改配置文件)
      - [2.3.5 开始微调](#235-开始微调)
      - [2.3.6 将得到的 PTH 模型转换为 HuggingFace 模型，**即：生成 Adapter 文件夹**](#236-将得到的-pth-模型转换为-huggingface-模型即生成-adapter-文件夹)
    - [2.4 部署与测试](#24-部署与测试)
      - [2.4.1 将 HuggingFace adapter 合并到大语言模型：](#241-将-huggingface-adapter-合并到大语言模型)
      - [2.4.2 与合并后的模型对话：](#242-与合并后的模型对话)
      - [2.4.3 Demo](#243-demo)
  - [3 自定义微调](#3-自定义微调)
    - [3.1 概述](#31-概述)
      - [3.1.1 **场景需求**](#311-场景需求)
      - [3.1.2 **真实数据预览**](#312-真实数据预览)
    - [3.2 数据准备](#32-数据准备)
      - [3.2.1 将数据转为 XTuner 的数据格式](#321-将数据转为-xtuner-的数据格式)
      - [3.2.2 划分训练集和测试集](#322-划分训练集和测试集)
    - [3.3 开始自定义微调](#33-开始自定义微调)
      - [3.3.1 准备配置文件](#331-准备配置文件)
      - [3.3.2 **XTuner！启动！**](#332-xtuner启动)
      - [3.3.3 pth 转 huggingface](#333-pth-转-huggingface)
      - [3.3.4 部署与测试](#334-部署与测试)
  - [4【补充】用 MS-Agent 数据集 赋予 LLM 以 Agent 能力](#4补充用-ms-agent-数据集-赋予-llm-以-agent-能力)
    - [4.1 概述](#41-概述)
    - [4.2 微调步骤](#42-微调步骤)
      - [4.2.1 准备工作](#421-准备工作)
      - [4.2.2 开始微调](#422-开始微调)
    - [4.3 直接使用](#43-直接使用)
      - [4.3.1 下载 Adapter](#431-下载-adapter)
      - [4.3.2 添加 serper 环境变量](#432-添加-serper-环境变量)
      - [4.3.3 xtuner + agent，启动！](#433-xtuner--agent启动)
      - [4.3.4 报错处理](#434-报错处理)
  - [5 其他已知问题和解决方案：](#5-其他已知问题和解决方案)
  - [6 注意事项](#6-注意事项)
